...
export default function VoiceCampaigns() {
  ...
  const [messageType, setMessageType] = useState<'upload' | 'text-to-speech'>('text-to-speech');
  ...
  const voiceOptions = [
    ...
    { value: 'authoritative-male', label: 'Authoritative Male', accent: 'American' },
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-gray-400 max-w-2xl mx-auto">
          Create and distribute AI-powered voice marketing messages with personalized delivery and comprehensive analytics.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-2">
          <h2 className="text-xl font-semibold text-white mb-4">Create Voice Campaign</h2>
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div className="text-gray-400 text-sm">AI Generated Voice</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-gray-400 text-sm">Pre-recorded Message</div>
                </button>
              </div>
            </div>
              ...
              <>
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Use {'{{name}}'}, {'{{company}}'} for personalization • Estimated duration: {Math.ceil(textMessage.length / 180)} seconds
                  </p>
                </div>
            ...
            {messageType === 'upload' && (
              <div>
                ...
                <div className="border-2 border-dashed border-gray-600 rounded-lg p-6 text-center hover:border-purple-500 transition-colors cursor-pointer">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Supports MP3, WAV files up to 10MB</p>
                </div>
              </div>
            )}
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-600 rounded-lg p-6 text-center hover:border-purple-500 transition-colors cursor-pointer">
                ...
                <p className="text-gray-400">Upload CSV with phone numbers and contact data</p>
                <p className="text-xs text-gray-500 mt-1">Include columns: phone, name, company, etc.</p>
              </div>
            </div>
            ...
            <GradientButton 
              ...
              disabled={!campaignTitle || (!textMessage && !uploadedAudio) || isSending}
              className="w-full flex items-center justify-center space-x-2"
            >
              <Send className="w-4 h-4" />
              <span>{isSending ? 'Sending Campaign...' : 'Send Voice Campaign'}</span>
            </GradientButton>
          </div>
        </Card>
        ...
        {/* Preview Card */}
        <Card>
          <h2 className="text-xl font-semibold text-white mb-4">Message Preview</h2>
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gray-900/50 rounded-lg">
              ...
              <div className="text-gray-300 text-sm">
                {messageType === 'text-to-speech' 
                  ? (textMessage || 'Your voice message script will appear here...')
                  : (uploadedAudio ? uploadedAudio.name : 'Upload an audio file to preview')
                }
              </div>
            </div>
            ...
            {personalizeMessages && (
              <div className="p-3 bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20 rounded-lg">
                ...
                <p className="text-xs text-gray-400">
                  Messages will be customized based on recipient data and engagement history.
                </p>
              </div>
            )}
          </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="text-left py-3 px-4 text-gray-300">Campaign Title</th>
                ...
                <th className="text-left py-3 px-4 text-gray-300">Engagement</th>
                <th className="text-left py-3 px-4 text-gray-300">Voice Type</th>
