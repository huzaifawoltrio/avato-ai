        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Comprehensive insights and AI-driven recommendations
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {kpiData.map((kpi, index) => {
          ...
          return (
            ...
            >
              <Card
                className={`bg-gradient-to-br ${kpi.bgColor} border-gray-600`}
              >
      ...
      <Card>
        ...
        <div className="space-y-4">
          {[
            {
              type: "email",
              title: "Q4 Newsletter Campaign",
              status: "completed",
              time: "2 hours ago",
            },
            {
              type: "voice",
              title: "Product Launch Voice Blast",
              status: "in-progress",
              time: "4 hours ago",
            },
            {
              type: "podcast",
              title: "Marketing Tips Episode #12",
              status: "completed",
              time: "1 day ago",
            },
            {
