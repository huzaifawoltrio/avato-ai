      ...
      <AnimatePresence>
        {isExpanded && (
          <motion.div
            ...
            className="absolute bottom-20 right-0 w-96 h-[500px] bg-gray-900/95 backdrop-blur-xl border border-purple-500/30 rounded-2xl shadow-2xl shadow-purple-500/10 overflow-hidden"
          >
            {!isMinimized && (
              <>
                {/* Header */}
